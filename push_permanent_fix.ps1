...
& $git add -A
& $git commit -m "fix: remover rotina assincrona de sobrescrita e garantir persistencia absoluta dos produtos"
...
Remove-Item push_permanent_fix.ps1 -Force -ErrorAction SilentlyContinue
